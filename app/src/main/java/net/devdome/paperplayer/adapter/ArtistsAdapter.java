...
public class ArtistsAdapter extends RecyclerView.Adapter<ArtistsAdapter.ArtistViewHolder> {
    ...
    public ArtistViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).
                inflate(R.layout.card_artist_grid, parent, false);
    ...
    public void onBindViewHolder(final ArtistViewHolder holder, final int position) {
        ...
        holder.numberOfSongs.setText(String.format(Locale.getDefault(), "%d %s", artists.get(position).getNumOfSongs(), strSongs));
//        try {
...
//        }
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(EXTRA_ARTIST_ID, artists.get(position).getId());
                intent.putExtra(EXTRA_ARTIST_NAME, artists.get(position).getName());
    ...
    static class ArtistViewHolder extends RecyclerView.ViewHolder {
        ...
        ArtistViewHolder(View itemView) {
            ...
            numberOfSongs = (TextView) itemView.findViewById(R.id.song_count);
        }
    }
}
