...
public class ArtistsAdapter extends RecyclerView.Adapter<ArtistsAdapter.ArtistViewHolder> {
    ...
    public ArtistsAdapter.ArtistViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_artist_list, parent,
                false);
    ...
    public class ArtistViewHolder extends RecyclerView.ViewHolder {
        ...
        public ArtistViewHolder(View itemView) {
            super(itemView);
            this.name = (TextView) itemView.findViewById(R.id.artist_name);
            this.artistImg = (ImageView) itemView.findViewById(R.id.artist_img);
            noOfRecords = (TextView) itemView.findViewById(R.id.artist_content_count);
        }
    }
}
